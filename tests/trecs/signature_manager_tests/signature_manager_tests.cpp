...
TEST_CASE( "assignment operator", "[SignatureManager]" )
{
   trecs::DefaultSignatureManager sig_manager_a;
   trecs::DefaultSignatureManager sig_manager_b;

   trecs::signature_t signatures[72];

   signatures[0] = sig_manager_a.registerComponent<component<0> >();
   signatures[1] = sig_manager_a.registerComponent<component<1> >();
   signatures[2] = sig_manager_a.registerComponent<component<2> >();
   signatures[3] = sig_manager_a.registerComponent<component<3> >();
   signatures[4] = sig_manager_a.registerComponent<component<4> >();
   signatures[5] = sig_manager_a.registerComponent<component<5> >();
   signatures[6] = sig_manager_a.registerComponent<component<6> >();
   signatures[7] = sig_manager_a.registerComponent<component<7> >();
   signatures[8] = sig_manager_a.registerComponent<component<8> >();
   signatures[9] = sig_manager_a.registerComponent<component<9> >();
   signatures[10] = sig_manager_a.registerComponent<component<10> >();
   signatures[11] = sig_manager_a.registerComponent<component<11> >();
   signatures[12] = sig_manager_a.registerComponent<component<12> >();
   signatures[13] = sig_manager_a.registerComponent<component<13> >();
   signatures[14] = sig_manager_a.registerComponent<component<14> >();
   signatures[15] = sig_manager_a.registerComponent<component<15> >();
   signatures[16] = sig_manager_a.registerComponent<component<16> >();
   signatures[17] = sig_manager_a.registerComponent<component<17> >();
   signatures[18] = sig_manager_a.registerComponent<component<18> >();
   signatures[19] = sig_manager_a.registerComponent<component<19> >();
   signatures[20] = sig_manager_a.registerComponent<component<20> >();
   signatures[21] = sig_manager_a.registerComponent<component<21> >();
   signatures[22] = sig_manager_a.registerComponent<component<22> >();
   signatures[23] = sig_manager_a.registerComponent<component<23> >();
   signatures[24] = sig_manager_a.registerComponent<component<24> >();
   signatures[25] = sig_manager_a.registerComponent<component<25> >();
   signatures[26] = sig_manager_a.registerComponent<component<26> >();
   signatures[27] = sig_manager_a.registerComponent<component<27> >();
   signatures[28] = sig_manager_a.registerComponent<component<28> >();
   signatures[29] = sig_manager_a.registerComponent<component<29> >();
   signatures[30] = sig_manager_a.registerComponent<component<30> >();
   signatures[31] = sig_manager_a.registerComponent<component<31> >();
   signatures[32] = sig_manager_a.registerComponent<component<32> >();
   signatures[33] = sig_manager_a.registerComponent<component<33> >();
   signatures[34] = sig_manager_a.registerComponent<component<34> >();
   signatures[35] = sig_manager_a.registerComponent<component<35> >();
   signatures[36] = sig_manager_a.registerComponent<component<36> >();
   signatures[37] = sig_manager_a.registerComponent<component<37> >();
   signatures[38] = sig_manager_a.registerComponent<component<38> >();
   signatures[39] = sig_manager_a.registerComponent<component<39> >();
   signatures[40] = sig_manager_a.registerComponent<component<40> >();
   signatures[41] = sig_manager_a.registerComponent<component<41> >();
   signatures[42] = sig_manager_a.registerComponent<component<42> >();
   signatures[43] = sig_manager_a.registerComponent<component<43> >();
   signatures[44] = sig_manager_a.registerComponent<component<44> >();
   signatures[45] = sig_manager_a.registerComponent<component<45> >();
   signatures[46] = sig_manager_a.registerComponent<component<46> >();
   signatures[47] = sig_manager_a.registerComponent<component<47> >();
   signatures[48] = sig_manager_a.registerComponent<component<48> >();
   signatures[49] = sig_manager_a.registerComponent<component<49> >();
   signatures[50] = sig_manager_a.registerComponent<component<50> >();
   signatures[51] = sig_manager_a.registerComponent<component<51> >();
   signatures[52] = sig_manager_a.registerComponent<component<52> >();
   signatures[53] = sig_manager_a.registerComponent<component<53> >();
   signatures[54] = sig_manager_a.registerComponent<component<54> >();
   signatures[55] = sig_manager_a.registerComponent<component<55> >();
   signatures[56] = sig_manager_a.registerComponent<component<56> >();
   signatures[57] = sig_manager_a.registerComponent<component<57> >();
   signatures[58] = sig_manager_a.registerComponent<component<58> >();
   signatures[59] = sig_manager_a.registerComponent<component<59> >();
   signatures[60] = sig_manager_a.registerComponent<component<60> >();
   signatures[61] = sig_manager_a.registerComponent<component<61> >();
   signatures[62] = sig_manager_a.registerComponent<component<62> >();
   signatures[63] = sig_manager_a.registerComponent<component<63> >();
   signatures[64] = sig_manager_a.registerComponent<component<64> >();
   signatures[65] = sig_manager_a.registerComponent<component<65> >();
   signatures[66] = sig_manager_a.registerComponent<component<66> >();
   signatures[67] = sig_manager_a.registerComponent<component<67> >();
   signatures[68] = sig_manager_a.registerComponent<component<68> >();
   signatures[69] = sig_manager_a.registerComponent<component<69> >();
   signatures[70] = sig_manager_a.registerComponent<component<70> >();
   signatures[71] = sig_manager_a.registerComponent<component<71> >();

   sig_manager_b = sig_manager_a;

   REQUIRE( sig_manager_b.getSignature<component<0> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<1> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<2> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<3> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<4> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<5> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<6> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<7> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<8> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<9> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<10> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<11> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<12> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<13> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<14> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<15> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<16> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<17> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<18> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<19> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<20> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<21> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<22> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<23> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<24> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<25> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<26> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<27> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<28> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<29> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<30> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<31> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<32> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<33> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<34> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<35> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<36> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<37> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<38> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<39> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<40> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<41> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<42> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<43> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<44> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<45> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<46> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<47> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<48> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<49> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<50> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<51> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<52> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<53> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<54> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<55> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<56> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<57> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<58> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<59> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<60> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<61> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<62> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<63> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<64> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<65> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<66> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<67> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<68> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<69> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<70> >() != trecs::error_signature);
   REQUIRE( sig_manager_b.getSignature<component<71> >() != trecs::error_signature);
